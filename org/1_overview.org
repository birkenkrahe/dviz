...
[[../img/1_tower.jpg]]
* Pre-test
I posted this infographic in the [[https://chat.google.com/room/AAAA9Fjdv8Q/zzm53xrpugo/zzm53xrpugo?cls=10][Google Chat Space]] claiming that is
was "not a great visualization"? Do you see anything wrong with it?
#+attr_html: :width 450px:
#+caption: Source Splashsys.com
[[../img/Ways-to-Search-Google.jpg]]

#+begin_quote
- *Distraction:* Colors are unmotivated (except to resemble the colors of the Google
  logo), but humans tend to look for meaning in the color pattern
- *Lingo:* Seems to be aimed at newbies and not digitally literate
  people ("bros" not "pros") but uses lingo like "operator".
- *Understanding:* The information can better be presented as a table so
  that descriptions that belong together (operator | example |
  explanation) can more easily be compared (and be remembered).
- *Ordering*: There is no ordering principle, and no attempt to order
  them.
- *Extension:* There is no reference or information on how to find out
  more even though it seems unlikely (but we're not told) that these
  are the only search tricks available ([[https://kinsta.com/blog/google-search-operators/][I found at least 40]]).
#+end_quote
...
- The [[https://github.com/birkenkrahe/dviz][GitHub repo]] contains course material:
  [[https://github.com/birkenkrahe/dviz][github.com/birkenkrahe/dviz]]
...
- If you don't know Emacs, [[https://lyon.instructure.com/courses/568/assignments/1436][complete the Emacs on-board tutorial]]!
...
- A subset of the test questions will form the final exam, which is
  optional (you don't have to do it if you're happy with your grade).
