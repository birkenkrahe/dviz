...
1) Run the code block named [[plot]] below. Open the notes to see the
   ...
   #+name: plot
   #+begin_src R :file ../img/plotWhiteside.png :session *R* :results output graphics file 
     library(MASS)
...
2) Create another code block ~plot1~ that uses ~plot~ to plot only the
   ...
   #+begin_src R :file ../img/plot1.png :session *R* :results output graphics file
     plot(whiteside$Temp)
   #+end_src
...
- Use =sort= to sort the values of =whiteside$Temp=.
   ...
   #+begin_src R :file ../img/plot2.png :session *R* :results output graphics file
...
- To distinguish which points belong to "Before" vs. "After", use color
  #+begin_src R :file ../img/color1.png :session *R* :results output graphics file
...
3) Open and close the explanation in the notes.
   ...
   #+name: barchart
   #+begin_src R :file ../img/barInsul.png :session *R* :results output graphics file
