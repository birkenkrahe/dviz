...
|------+---------------------------------------------------+------------|
|   10 | [[https://app.datacamp.com/learn/courses/introduction-to-data-visualization-with-plotly-in-python][Introduction to Plotly]]                            |            |
|------+---------------------------------------------------+------------|
|   11 | [[https://app.datacamp.com/learn/courses/dashboard-design-concepts][Introduction to dashboards]]                        | 3rd review |
|------+---------------------------------------------------+------------|
|   12 | [[https://app.datacamp.com/learn/courses/introduction-to-power-bi][Introduction to Power BI: Getting started]]         |            |
|------+---------------------------------------------------+------------|
|   13 | Introduction to Power BI: Transforming data       |            |
|------+---------------------------------------------------+------------|
|   14 | Introduction to Power BI: Visualizing data        |            |
|------+---------------------------------------------------+------------|
|   15 | Introduction to Power BI: Filtering               | 4th review |
|------+---------------------------------------------------+------------|
