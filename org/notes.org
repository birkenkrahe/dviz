...
* IN PROGRESS Week 3 - Emacs + R + Linux
#+attr_html: :width 400px:
...
** IN PROGRESS Review: DataCamp lesson "The Color and the Shape"
...
Housekeeping:
- [ ] New quiz coming at you later today
- [ ] New DataCamp lessons live: Data visualization with ~ggplot2~
- [ ] Will (probably) change syllabus and continue with ~plotly~
- [ ] A couple of you did not meet the DataCamp deadline: watch it!
- [ ] If you submit late or if I made a grading mistake: let me know!
- [ ] *Several of you missed a project deadline (Canvas list)*

Content:
- [ ] Review package installation (~scatterplot3d~)
- [ ] Finish review DataCamp lesson "The Color and the Shape" (plots!)
