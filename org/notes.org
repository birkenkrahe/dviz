...
10. Is the =as.character= function generic?
    ...
    #+RESULTS:
    : [1] "function"
    : [1] as.character.condition       as.character.Date           
    :  [3] as.character.default         as.character.error          
    :  [5] as.character.factor          as.character.fractions*     
    :  [7] as.character.hexmode         as.character.numeric_version
    :  [9] as.character.octmode         as.character.person*        
    : [11] as.character.POSIXt          as.character.Rd*            
