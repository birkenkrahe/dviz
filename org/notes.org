...
** IN PROGRESS Exercise: Plotting in Python
...
2. Check with =ls -l= on the shell that the file was created:
   ...
   #+RESULTS:
   : -rw-rw-r-- 1 aletheia aletheia 761976 Oct 23 13:35 weather.csv
...
10. Put the two plots next to one another instead of on top of one
    another:
    #+begin_src python :file :results file graphics output :session *Python* :python python3 :exports both
...
- [ ] Graphics lab last Monday (failed)
- [ ] Finish Python plotting (=subplots=).
- [ ] DataCamp review: The Grammar of Graphics (gg) plotting lab.
- [ ] Base R =plot= function revisited.
- [ ] Next DataCamp lesson due: Stats with =matplotlib=
- [ ] Next week: The =plotly= package & quiz 8 (DataCamp and ggplot2)
...
- You'll get feedback some time this week.
- Remember that there is no 2-for-1 (every team must submit).
- The feedback will be a note in your NotebookLM dashboard.
...
#+RESULTS:
: -rw-rw-r-- 1 aletheia aletheia 3678 Oct 23 13:51 ggplot2.org
