...
** DONE Base R EDA and =ggplot2= popquiz
...
** DONE Project update - first podcasts & literature reviews
#+attr_html: :width 400px: 
...
** IN PROGRESS Data visualization with =matplotlib= in Emacs
...
- How about rebuilding the =mtcars= plot that we always do?
  ...
  1) [[https://gist.githubusercontent.com/seankross/a412dfbd88b3db70b74b/raw/5f23f993cd87c283ce766e7ac6b329ee7cc2e1d1/mtcars.csv][Get mtcars from GitHub]] as a CSV file: [[https://tinyurl.com/mtcars-csv-data][tinyurl.com/mtcars-csv-data]]
     ...
     #+RESULTS:
     : -rw-rw-r-- 1 marcus marcus 1700 Oct 11 15:33 mtcars.csv
...
* Week 9 - Graphics & Grammar of Graphics
#+attr_html: :width 600px: 
[[../img/leonardo.jpg]]

/Image: Leonardo Da Vinci, The Last Supper/

- [ ] Finish =matplotlib= introduction (=mtcars=)
- [ ] Review plotting time series with Python and R
- [ ] Alternative R graphics packages
- [ ] The Grammar of Graphics (gg)

** TODO Review: Plotting time series with Python and R
