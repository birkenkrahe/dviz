...
1. What does =plot= generate when you feed it with two =factor= variables?
   ...
   Plot: attempt 1
   #+begin_src R :file mosaic.png :session *R* :results file graphics output :exports both
     plot(x=cyl, y=gear)
   #+end_src
   ...
   Plot: attempt 2
   #+begin_src R :file mosaic2.png :session *R* :results file graphics output :exports both
     plot(cyl_gear_table)
   #+end_src
...
2. When plotting a time series, what's the best way to visualize it?
   #+begin_src R :file ts.png :session *R* :results file graphics output :exports both
...
3. You've got two numeric distributions of related observations (for
   ...
   #+begin_src R :file boxplot.png :session *R* :results file graphics output :exports both
     library(MASS)
     data(whiteside)
...
2. Which function controls graphics for R and how can you see its
   ...
   List of 72
    ...
    $ col.main : chr "black"
    $ col.sub  : chr "black"
    $ cra      : num [1:2] 14.7 19.6
    $ crt      : num 0
    $ csi      : num 0.2
    $ cxy      : num [1:2] 0.026 0.0388
    $ din      : num [1:2] 7 6.99
    $ err      : int 0
    $ family   : chr ""
    $ fg       : chr "black"
...
3. Which command sequence sets up 2 x 2 empty plots per page frame?
   #+begin_src R :file frame.png :session *R* :results file graphics output :exports both
     par(mfrow=c(2,2))
     for (i in 1:4)
       plot(0,type="n")
   #+end_src
...
4. Which =plot= parameter family controls text and symbols scales?
   #+begin_src R :file cex.png :session *R* :results file graphics output :exports both
...
- [ ] Finish =plot= code along lecture: [[https://tinyurl.com/plot-codealong][tinyurl.com/plot-codealong]]
- [ ] =plot= lab with NHANES data: [[https://tinyurl.com/plots-lab][tinyurl.com/plots-lab]]
- [ ] New quiz (9) available until Nov 8 (=plotly= and =plot=)
- [ ] Bonus exercise: redo the =NHANES= plot with =ggplot2=
- [ ] Next DataCamp lesson: Dashboard Design
...
4. How does =plotly.express= work?
   ...
   #+begin_src python :results file graphics none :session *Python* :python python3 :file p.png
...
7. How could you used =color= in the bar chart for this data frame?
   ...
   #+begin_src python :file p.png :results file graphics output :session *Python* :python python3
     import plotly.express as px
     fig=px.bar(
...
8. color scales for continuous variables

9. update the layout of an existing figure
